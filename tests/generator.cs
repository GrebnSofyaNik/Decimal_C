...
class Program
{
  ...
  public static void s21_div()
  {
    ...
    using (BinaryWriter writer = new BinaryWriter(File.Open(path, FileMode.OpenOrCreate)))
    {
      ...
      //   }
      // }
      writer.Write(4221.06464609879837538760m);
      writer.Write(132432432432427.000m);
      writer.Write(4221.06464600m / 132432432432427.000m);
    }
  ...
  public static void s21_is_less()
  {
    ...
    using (BinaryWriter writer = new BinaryWriter(File.Open(path, FileMode.OpenOrCreate)))
    {
      decimal i;
      decimal j;
      for (decimal a = -3.1415926535897932384626433833m; a < 3.1415926535897932384626433833m; a += 3.1415926535897932384626433833m / 20m)
      {
        for (decimal b = -3.1415926535897932384626433833m; b < 3.1415926535897932384626433833m; b += 3.1415926535897932384626433833m / 20m)
        {
